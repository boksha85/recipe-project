package com.boksha.recipeproject.bootstrap;

import com.boksha.recipeproject.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    //needed for bidirectional - should be in one method - remove line under so now it is ok
    //guacNotes.setRecipe(guacRecipe);
    guacRecipe.setNotes(guacNotes);

    //very redudent - could add helper method and make it easer *** remove recipe from constructor so now it is ok
